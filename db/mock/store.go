...
// Source: github.com/joshuandeleva/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 db.CreateEntryParams) (db.Entery, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Entery)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (db.Entery, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 db.ListEntriesParams) ([]db.Entery, error) {
	m.ctrl.T.Helper()
